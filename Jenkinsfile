 ...
 stage('Install Dependencies') {
    ...
    stage('Docker Build and Push') {
      steps {
          ...
          sh 'docker build -t 0914818516/food-delivery-app-fe:${VERSION} .'
          sh 'docker push 0914818516/food-delivery-app-fe:${VERSION}'
      }
    }
     ...
     stage('Update Image Tag in GitOps') {
      steps {
       ...
       sh '''
          sed -i "s/image:.*/image: 0914818516\\/food-delivery-app-fe:${VERSION}/" aws/angular-manifest.yml
        '''
